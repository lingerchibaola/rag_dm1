            ...
            if bg_choice == "默认图片":
                ...
                if Path(default_bg).exists():
                    ...
                    st.markdown(
                        ...
                        [data-testid="stSidebar"] *, .stCaption, .stAlert,
                        ...
                        .main-title {{
                            background: linear-gradient(135deg, {st.session_state.font_color} 0%, {st.session_state.font_color} 100%);
...
# 自定义CSS - 添加可爱样式（保持原有样式，但去掉硬编码的颜色）
st.markdown(f"""
<style>
    /* 可爱字体和颜色 */
...
<div class="cute-decoration">
    ...
    <p style="font-size: 0.7em; color: {st.session_state.font_color};"> 小助手会努力给你最好的答案 </p>
</div>
""", unsafe_allow_html=True)
